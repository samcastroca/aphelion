...
Uso:
    ...
    uv run python scripts/02_fragmentar.py --max-tokens 768 --salida trabajo/frag_768.jsonl
"""
...
from aphelion import chunking, config, limpieza
...
def main() -> int:
    ...
    if not archivos:
        print("No hay texto extraído. Ejecuta antes scripts/01_extraer.py")
        return 1

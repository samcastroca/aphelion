...
Uso:
    uv run python scripts/analisis/evaluar.py
    uv run python scripts/analisis/evaluar.py --resultados otra_corrida.jsonl --detalle
"""
...
def main() -> int:
    ...
    if not args.ground_truth.exists():
        ...
        print("Construye el ground truth con scripts/analisis/pool_anotacion.py y anótalo.")
        return 1
